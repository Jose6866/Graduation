...
message(STATUS "ros_yolo: 2 messages, 0 services")

set(MSG_I_FLAGS "-Iros_yolo:/home/cilab/project/src/ros_yolo/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/cilab/project/src/ros_yolo/msg/Depth.msg" NAME_WE)
add_custom_target(_ros_yolo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_yolo" "/home/cilab/project/src/ros_yolo/msg/Depth.msg" ""
)

get_filename_component(_filename "/home/cilab/project/src/ros_yolo/msg/Detection.msg" NAME_WE)
add_custom_target(_ros_yolo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_yolo" "/home/cilab/project/src/ros_yolo/msg/Detection.msg" ""
)
